...
const translations: Record<string, Record<Language, string>> = {
  ...
  // Authentication
  "auth.loginSuccess": { en: "Login Successful", ur: "لاگ ان کامیاب" },
  "auth.welcomeBack": { en: "Welcome back!", ur: "خوش آمدید!" },
  "auth.loginFailed": { en: "Login failed. Please check your credentials.", ur: "لاگ ان ناکام۔ براہ کرم اپنے کریڈنشلز چیک کریں۔" },
  "auth.loginError": { en: "Login Error", ur: "لاگ ان کی خرابی" },
  "auth.loggedOut": { en: "Logged Out", ur: "لاگ آؤٹ ہو گئے" },
  "auth.logoutSuccess": { en: "You have been logged out successfully.", ur: "آپ کامیابی سے لاگ آؤٹ ہو گئے ہیں۔" },
  "auth.logoutError": { en: "Logout Error", ur: "لاگ آؤٹ کی خرابی" },
  "auth.logoutFailed": { en: "Failed to logout. Please try again.", ur: "لاگ آؤٹ ناکام۔ براہ کرم دوبارہ کوشش کریں۔" },
};
